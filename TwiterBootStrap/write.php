...
<body id="target">
    ...
    while( $row = mysqli_fetch_assoc($result)){
      echo '<li><a href="http://localhost:8080/TwiterBootStrap/index.php'.$row['id'].'">'.$row['title'].'</a></li>'."\n";
    }
    ?>
        </ol>
    </nav>
  ...
  <article>
    <form action="http://localhost:8080/TwiterBootStrap/process.php" method="post">
      <p>
